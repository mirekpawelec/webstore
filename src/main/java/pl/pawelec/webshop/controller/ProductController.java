...
public class ProductController {
    ...
    public String processUpdateProductForm(@ModelAttribute("updateProductForm") @Validated({Product.updateForm.class}) Product productToBeUpdate,
    ...
    public String processAddProductForm(@ModelAttribute("newProductForm") @Validated({Product.newForm.class}) Product productToBeAdd,
                                        BindingResult result, HttpServletRequest request, final RedirectAttributes redirect) {
        if (result.hasErrors()) {
            return "addProductForm";
        }
